...
use infrablockspace_primitives::UpgradeGoAhead;
...
impl RelayStateSproofBuilder {
	...
	pub fn into_state_root_and_proof(
		self,
	) -> (infrablockspace_primitives::Hash, sp_state_machine::StorageProof) {
		let (db, root) =
			MemoryDB::<HashFor<infrablockspace_primitives::Block>>::default_with_root();
