...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("Infra Asset Hub TestNet"),
	impl_name: create_runtime_str!("Infra Asset Hub TestNet"),
	authoring_version: 1,
	spec_version: 9370,
	impl_version: 0,
...
parameter_types! {
	pub const AssetDeposit: Balance = 1 * UNITS; // 10 UNITS deposit to create fungible asset class
